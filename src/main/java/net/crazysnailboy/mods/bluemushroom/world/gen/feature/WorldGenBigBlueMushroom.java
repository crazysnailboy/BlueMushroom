package net.crazysnailboy.mods.bluemushroom.world.gen.feature;
...
public class WorldGenBigBlueMushroom extends WorldGenerator
{

	private final Block mushroomType;

	public WorldGenBigBlueMushroom(Block mushroomType)
	{
		super(true);
		this.mushroomType = mushroomType;
	}

	public WorldGenBigBlueMushroom()
	{
		super(false);
	...
	public boolean generate(World worldIn, Random rand, BlockPos position)
	{
		...
		if (block == null)
		{
			block = ModBlocks.BLUE_MUSHROOM_BLOCK;
		}
		...
		if (position.getY() >= 1 && position.getY() + i + 1 < 256)
		{
			...
			else
			{
				...
				else
				{
					...
					if (block == ModBlocks.BLUE_MUSHROOM_BLOCK)
					{
